...
#### p. Instructions
  ...
  * Clone repository '$ git clone https://github.com/<Wherever this project is hosted>'
  * Unzip and restore "cafusion" database located inside project folder "_SQLBackup" (Assumes SQL 2016)
  * After restoring database run script "CreateDimDate.sql" 
  * Update "appsettings.json" with connection string details to the restored database
...
### VISUAL STUDIO:
  ...
  * Install-Package SurveyMonkeyApi -Version 3.2.181 (Use Postman to test how Survey Monkey API calls work).
